...
$dd2= $var1 + ($var2/60) + ($var3/3600);
 ...
 $stmt->execute(array(':reg' =>$mad3 ,':stat' =>$_GET['name2'] ,':vil'=>$_GET['village'],':dist' =>$_GET['dist'],':state' =>$_GET['state'],':comdate' =>$_GET['date'],':state' =>$_GET['state'],':client' =>$_GET['owner'],':lat' =>$dd1,':long' =>$dd2,':mast' =>$_GET['mast'],':amt' =>$_GET['amt'],':date' =>$_GET['receipt'],':ddno' =>$_GET['dd'],':follow' =>$_GET['follow'],':survey' =>$_GET['survey'],':comment' =>$_GET['comment'] ));
}
