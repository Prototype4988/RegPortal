...
$success = "";
$error_message = "";
$conn = mysqli_connect("localhost","root","root","niwe");
...
$result = mysqli_query($conn,"SELECT * FROM users WHERE email='" . $_POST["email"] . "'");
	...
	if($count>0) {
		// generate OTP
		$otp = rand(100000,999999); //generating a random otp
		// Send OTP
		...
		if($mail_status == 1) 
		{
			...
			$current_id = mysqli_insert_id($conn); //storing the timestamp and otp
